      ...
      <div class="col-md-6 hero-text">
        <div class="dropdown">
          <button class="btn dropdown-toggle" type="button" id="produkDropdown" data-bs-toggle="dropdown" aria-expanded="false">
            <h1>Apple Watch <br> Series 10</h1>
          </button>
      ...
      <div class="parent">
        ...
        <div class="div3">
          <table class="table-table table-sm">
            <tr>
              <th>Bahan</th>
              <td>Casing Alumunium dan Titanium(46 mm dan 42 mm)</td>
            </tr>
            <tr>
              <th>Layar</th>
            ...
            <tr>
              <th>Chip</th>
              <td>S10 SiP (prosesor dual-core 64-bit)</td>
            </tr>
            <tr>
              <th>Sensor</th>
              <td>Sensor jantung optik; sensor suhu; sensor cahaya ambient</td>
            </tr>
            <tr>
              <th>Konektivitas</th>
              <td>Wi-Fi; Bluetooth; GPS/GNSS; mode GPS+ Seluler</td>
            </tr>
            <tr>
              <th>Daya & Baterai</th>
              <td>36 Jam(penggunaan normal)</td>
            </tr>
            <tr>
              <th>Ketahanan</th>
        ...
        <div class="div7 text-center">
          <p>Apple Watch Series 10 menghadirkan desain yang lebih tipis dan ringan dengan layar lebih besar, serta fitur kesehatan dan keselamatan yang ditingkatkan, menjadikannya pilihan ideal bagi pengguna yang menginginkan smartwatch canggih dan modern.</p>
        </div>
      </div>
