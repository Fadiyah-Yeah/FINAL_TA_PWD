...
$produk = "Apple Watch SE (Generasi ke-2)";
      ...
      <div class="col-md-6 hero-text">
        <div class="dropdown">
          <button class="btn dropdown-toggle" type="button" id="produkDropdown" data-bs-toggle="dropdown" aria-expanded="false">
            <h1>Apple Watch SE <br>(Generasi Ke-2)</h1>
          </button>
        ...
        <p><b>Harga: </b>Mulai dari Rp 3.399.000</p>
      </div>
      <div class="col-md-6 text-center">
        <img src="se.png" alt="4" class="img-fluid">
      </div>
    </div>
  </div>
</section>
        ...
        <div class="div5">
          <table class="table-table table-sm">
            <tr>
              ...
              <td>: Pelacakan aktivitas, deteksi jatuh, dan pelacakan siklus menstruasi.</td>
            </tr>
            <tr>
              <th>Keselamatan</th>
            ...
            <tr>
              ...
              <td>Casing aluminium 100% daur ulang.</td>
            </tr>
          </table>
        </div>
