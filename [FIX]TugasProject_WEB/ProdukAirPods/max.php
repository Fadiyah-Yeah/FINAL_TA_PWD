      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 hero-text">
            ...
            <p><b>Harga: </b>Mulai dari Rp 8.799.000</p>
          </div>
          <div class="col-md-6 text-center">
            <img src="max.png" alt="4" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="parent">
        ...
        <div class="div3 table-responsive">
          <table class="table-table table-sm table-striped">
            ...
            <tbody>
              <tr>
                <td>Driver dinamis</td>
                <td>Sensor optik</td>
                <td>9 mic aktif(8 peredam kebisinga, 3 deteksi suara)</td>
                <td>H1 di setiap penutup telinga</td>
                <td>Digital Crown</td>
                <td>Tinggi 187,3 mm</td>
                <td>Waktu dengar hingga 20 jam</td>
              </tr>
              <tr>
                <td>Peredam Kebisingan Aktif</td>
                <td>Sensor posisi</td>
                <td></td>
                <td></td>
                <td>Tombol Kontrol kebisingan</td>
                <td>Lebar 168,6 mm</td>
                <td>Pengisian daya selama 5 menit, memberi waktu dengar 1,5 jam</td>
              </tr>
              <tr>
                <td>Mode Transparansi</td>
                <td>Sensor deteksi</td>
                <td></td>
                <td></td>
                <td></td>
                <td>Tebal 83,4 mm</td>
              ...
              <tr>
                <td>Audio Spasial Personal</td>
                <td>Akselerometer</td>
                <td></td>
                <td></td>
                <td></td>
                <td>Berat 384,8 gram</td>
        ...
        <div class="div5 table-responsive">
          <table class="table-table table-sm table-striped">
            ...
            <tr>
              <th>Isi Kotak</th>
              <td>AirPods Max, Smart Case, Kabel Lightning ke USB-C</td>
            </tr>
          </table>
        </div>
        ...
        <div class="div7 text-center">
          <p>AirPods Max menawarkan pengalaman audio premium dengan desain over-ear, dilengkapi dengan fitur-fitur canggih seperti Peredam Kebisingan Aktif dan Audio Spasial Personal.</p>
        </div>
      </div>
