      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 hero-text">
            ...
            <p><b>Harga: </b>Mulai dari Rp 1.899.000</p>
          </div>
          <div class="col-md-6 text-center">
            <img src="gen2 (2).png" alt="4" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section-spesifikasi text-white" id="spesifikasi">
      ...
      <div class="parent">
          ...
          <table class="table-table table-sm table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td>Sensor Optik Ganda</td>
                <td>Mikrofon ganda pembentuk sinyal</td>
                <td>H1 Apple</td>
                <td>Ketuk 2 kali untuk memutar, melompat maju, atau menjawab panggilan</td>
                <td>Airpods(masing-masing) : Tinggi 40,5 mm; Lebar 16,5 mm; Tebal 18,0 mm; Berat 4 gram</td>
                <td>Waktu dengar hingga 5 jam</td>
              </tr>
              <tr>
                <td>Amplifier rentang dimanis tinggi kustom</td>
                <td>Akselerometer pendeteksi gerat</td>
                <td></td>
                <td></td>
                <td></td>
                <td>Casing : Tinggi 53,5 mm; Lebar 44,3 mm; tebal 21,3 mm; Berat 38,2 mm</td>
                <td>Lebih dari 24 jam wkatu dengan dengan casing pengisian daya</td>
              </tr>
              <tr>
                <td></td>
        ...
        <div class="div5 table-responsive">
          <table class="table-table table-sm table-striped">
            <tr>
              ...
              <td>Kenyamanan dan sound bass yang stabil untuk pengguna</td>
            </tr>
            <tr>
              <th>Ketahanan & AKsesibilitas</th>
              <td>Fitur aksesibilitas membantu penyandang disabilitas memasimalkan AirPods Max</td>
            </tr>
            <tr>
              <th>Isi Kotak</th>
              <td>AirPods, casing Pengisian Daya, Kabel Lightning ke USB-A</td>
            </tr>
          </table>
        </div>
        ...
        <div class="div7 text-center">
          <p>AirPods Generasi Ke-2 menawarkan pengalaman nirkabel yang mulus dengan kualitas suara yang baik dan integrasi yang mudah dengan perangkat Apple.</p>
        </div>
      </div>
