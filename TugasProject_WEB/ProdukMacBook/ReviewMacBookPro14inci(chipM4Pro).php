...
$produk = "MacBook Pro 14 inci (chip M4 Pro)";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($komentar)) {
        ...
        if (mysqli_query($conn, $query)) {
            ...
            header("Location: ReviewMacBookPro14inci(chipM4Pro).php");
        }
    }
}
?>
                    ...
                    <div class="col-md-6 hero-text">
                        <div class="dropdown">
                            <button class="btn dropdown-toggle" type="button" id="produkDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                <h1> MacBook Pro 14(M4 Pro)</h1>
                            </button>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="ReviewMacBookAir13inci.php"> MacBook Air 13 inci (chip M4)</a></li>
                                <li><a class="dropdown-item" href="ReviewMacBookPro14inci(chipM2Max).php">MacBook Pro 14 inci (chip M2 Max)</a></li>
                            </ul>
                        </div>
                        <p><b>Harga: </b>Mulai dari Rp 27.999.000</p>
                    </div>
                    <div class="col-md-6 text-center">
                        <img src="MacBoo Pro 14 inci (chip M4 Pro).jpg" alt="4" class="img-fluid" style="width: 400px; height:550px; border-radius:30px; box-shadow: 0 20px 36px rgb(0 0 0 / 0.1);">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="parent">
                ...
                <div class="div3">
                    <table class="table-table table-sm">
                        <tr>
                            <th>Layar</th>
                            <td>Liquid Retina XDR 14,2 inci (3024 × 1964), ProMotion 120 Hz, P3, True Tone, kecerahan XDR hingga 1600 nit</td>
                        </tr>
                        <tr>
                            <th>Chip</th>
                            <td>CPU 12-core (8 performa + 4 efisiensi), GPU 16-core (opsi GPU 20-core), Neural Engine 16-core, bandwidth memori 273 GB/s</td>
                        </tr>
                        <tr>
                            <th>Kamera</th>
                            <td>Kamera FaceTime HD 1080p dengan ISP canggih</td>
                        </tr>
                        <tr>
                            <th>Audio</th>
                            <td>Enam speaker high-fidelity + Audio Spasial, tiga mikrofon kualitas studio</td>
                        </tr>
                        <tr>
                            <th>Penyimpanan</th>
                ...
                <div class="div5">
                    <table class="table-table table-sm">
                        <tr>
                            ...
                            <td>Magic Keyboard + Touch ID + trackpad Force Touch</td>
                        </tr>
                        <tr>
                            <th>Fitur AI</th>
                            <td>Apple Intelligence (macOS 14 Sonoma) terintegrasi penuh</td>
                        </tr>
                        <tr>
                            <th>Fitur Keamanan</th>
                            <td>Keamanan Secure Enclave + enkkripsi memori terintegrasi</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="div7 text-center">
                    <p>MacBook Pro 14 inci dengan chip M4 Pro atau M4 Max dirancang untuk profesional yang membutuhkan performa maksimal. Dengan layar Liquid Retina XDR, RAM hingga 48 GB, dan penyimpanan hingga 8 TB, laptop ini cocok untuk tugas berat seperti pengeditan video dan pemrograman. Harga mulai dari Rp 28 juta hingga Rp 68 juta, tergantung konfigurasi.</p>
            </div>
