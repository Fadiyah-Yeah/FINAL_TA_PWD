...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($komentar)) {
        ...
        if (mysqli_query($conn, $query)) {
            ...
            header("Location: ReviewMacBookAir13inci.php");
        }
    }
}
?>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-center">
                        <img src="MacBook Air 13.jpg" alt="4" class="img-fluid" style="width: 400px; height:550px; border-radius:30px; box-shadow: 0 20px 36px rgb(0 0 0 / 0.1);">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="parent">
                ...
                <div class="div3">
                    <table class="table-table table-sm">
                        <tr>
                            <th>Layar</th>
                            <td>Liquid Retina 13,6 inci (2560 × 1664 piksel), kecerahan hingga 500 nit, gamut warna P3, True Tone</td>
                        </tr>
                        <tr>
                            <th>Chip</th>
                            <td>Chip Apple M4 dengan CPU 10-core (4 core performa + 6 core efisiensi), GPU 8-core (opsi GPU 10-core), Neural Engine 16-core</td>
                        </tr>
                        <tr>
                            <th>Kamera</th>
                            <td>Kamera FaceTime HD 12 MP dengan Center Stage</td>
                        </tr>
                        <tr>
                            <th>Audio</th>
                        ...
                        <tr>
                            <th>Penyimpanan</th>
                            <td>SSD mulai 256 GB, opsi hingga 2 TB</td>
                        </tr>
                        <tr>
                            <th>Daya & Baterai</th>
                ...
                <div class="div5">
                    <table class="table-table table-sm">
                        <tr>
                            ...
                            <td>Dua port Thunderbolt 4 (USB-C) + port MagSafe 3</td>
                        </tr>
                        <tr>
                            <th>Konektivitas</th>
                ...
                <div class="div7 text-center">
                    <p>MacBook Air 13 inci dengan chip M4 menawarkan performa tinggi dalam desain tipis dan ringan. Dilengkapi dengan layar Liquid Retina, daya tahan baterai hingga 18 jam, dan sistem pendingin tanpa kipas, laptop ini ideal untuk pengguna yang membutuhkan mobilitas tinggi. Harga mulai dari sekitar Rp 13 juta.</p>
            </div>
