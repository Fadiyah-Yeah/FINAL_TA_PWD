            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 hero-text">
                        ...
                        <p><b>Harga: </b>Mulai dari Rp 12.749.000</p>
                    </div>
                    <div class="col-md-6 text-center">
                        <img src="iPhone16e.jpg" alt="4" class="img-fluid" style="width: 400px; height:550px; border-radius:30px; box-shadow: 0 20px 36px rgb(0 0 0 / 0.1);">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="parent">
                ...
                <div class="div3">
                    <table class="table-table table-sm">
                        <tr>
                            <th>Bahan</th>
                            <td>Desain aluminium dengan Ceramic Shield di depan</td>
                        </tr>
                        <tr>
                            <th>Layar</th>
                            <td>Super Retina XDR OLED 6,06 inci (2532 × 1170 piksel, 460 ppi)</td>
                        </tr>
                        <tr>
                            <th>Chip</th>
                            <td>Chip Apple A18 (4 core GPU, 6 core CPU, Neural Engine 16-core)</td>
                        </tr>
                        <tr>
                            <th>Kamera</th>
