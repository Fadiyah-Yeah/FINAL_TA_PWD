                    ...
                    <div class="col-md-6 hero-text">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="ReviewIphone16pro.php">iPhone 16 Pro</a></li>
                                <li><a class="dropdown-item" href="ReviewIphone16e.php">iPhone 16e</a></li>
                            </ul>
                        </div>
                        <p><b>Harga: </b>Mulai dari Rp 13.499.000</p>
                    </div>
                    <div class="col-md-6 text-center">
                        <img src="iPhone15plus.jpg" alt="4" class="img-fluid" style="width: 400px; height:550px; border-radius:30px; box-shadow: 0 20px 36px rgb(0 0 0 / 0.1);">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="parent">
                ...
                <div class="div3">
                    <table class="table-table table-sm">
                        <tr>
                            <th>Bahan</th>
                            <td>Frame aluminium dengan Ceramic Shield di depan</td>
                        </tr>
                        <tr>
                            <th>Layar</th>
                            <td>Super Retina XDR OLED 6,7 inci (2796 × 1290 piksel, 460 ppi) dengan 120 Hz</td>
                        </tr>
                        <tr>
                            <th>Chip</th>
                        ...
                        <tr>
                            <th>Kamera</th>
                            <td>Kamera Wide 48 MP (dual-pixel PDAF, sensor quad-pixel)</td>
                        </tr>
                        <tr>
                            <th>Audio</th>
                        ...
                        <tr>
                            <th>Daya & Baterai</th>
                            <td>26 Jam(penggunaan normal)</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="div5">
                    <table class="table-table table-sm">
                        <tr>
                            ...
                            <td>Face ID, USB-C, MagSafe</td>
                        </tr>
                        <tr>
                            <th>Konektivitas</th>
                            <td>5G, Wi-Fi 6E, Bluetooth 5.3, UWB</td>
                        </tr>
                        <tr>
                            <th>Fitur AI</th>
                            <td>Apple Intelligence di iOS 18 (Visual Intelligence)</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="div7 text-center">
                    <p>iPhone 15 Plus menawarkan layar lebih besar 6,7 inci, chip A16 Bionic, dan sistem kamera ganda 48 MP. Dengan daya tahan baterai yang lebih lama, perangkat ini ideal untuk pengguna yang menginginkan layar besar dan performa tinggi. Harga mulai dari Rp 18.999.000 untuk varian 128 GB.</p>
                </div>
            </div>
