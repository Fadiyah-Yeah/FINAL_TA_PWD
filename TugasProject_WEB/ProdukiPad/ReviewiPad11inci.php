...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($komentar)) {
        ...
        if (mysqli_query($conn, $query)) {
            ...
            header("Location: ReviewiPad11inci.php");
        }
    }
}
?>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 hero-text">
                        ...
                        <p><b>Harga: </b>Mulai dari Rp 5.800.000</p>
                    </div>
                    <div class="col-md-6 text-center">
                        <img src="iPad11inci(A16chip).jpg" alt="4" class="img-fluid" style="width: 400px; height:550px; border-radius:30px; box-shadow: 0 20px 36px rgb(0 0 0 / 0.1);">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="parent">
                ...
                <div class="div3">
                    <table class="table-table table-sm">
                        <tr>
                            <th>Layar</th>
                            <td>Liquid Retina 11 inci (2360 × 1640 piksel, 264 ppi) dengan True Tone, kecerahan 500 nit, lapisan oleophobic anti-sidik jari</td>
                        </tr>
                        <tr>
                            <th>Chip</th>
                            <td>Chip Apple A16 Bionic (6 core CPU, 5 core GPU, Neural Engine 16-core)</td>
                        </tr>
                        <tr>
                            <th>Kamera</th>
                ...
                <div class="div5">
                    <table class="table-table table-sm">
                        <tr>
                            ...
                            <td>Mendukung Apple Pencil (USB-C) dan Apple Pencil (generasi ke-1)</td>
                        </tr>
                        <tr>
                            <th>Konektivitas</th>
                ...
                <div class="div7 text-center">
                    <p>iPad generasi terbaru dengan chip A16 menawarkan peningkatan performa dan efisiensi. Dengan penyimpanan mulai dari 128 GB dan kompatibilitas dengan Apple Pencil, perangkat ini ideal untuk penggunaan sehari-hari. Harga mulai Rp 5.800.000</p>
                </div>
            </div>
