...
$produk = "iPad Pro 13 inci (chip M4)";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($komentar)) {
        ...
        if (mysqli_query($conn, $query)) {
            ...
            header("Location: ReviewiPadPro13inci.php");
        }
    }
}
?>
                    ...
                    <div class="col-md-6 hero-text">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="ReviewiPadMini.php">iPad mini</a></li>
                            </ul>
                        </div>
                        <p><b>Harga: </b>Mulai dari Rp 25.499.000</p>
                    </div>
                    <div class="col-md-6 text-center">
                        <img src="iPad Pro 13 inci (chip m4).jpg" alt="4" class="img-fluid" style="width: 400px; height:550px; border-radius:30px; box-shadow: 0 20px 36px rgb(0 0 0 / 0.1);">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="parent">
                ...
                <div class="div3">
                    <table class="table-table table-sm">
                        <tr>
                            <th>Layar</th>
                            <td>Ultra Retina XDR 13 inci dengan ProMotion (120 Hz), gamut warna P3, True Tone, lapisan anti-reflektif</td>
                        </tr>
                        <tr>
                            <th>Chip</th>
                            <td>Chip Apple M4, Model 256 GB/512 GB: CPU 9-core (3 core performa + 6 efisiensi), GPU 10-core, Neural Engine 16-core, RAM 8 GB</td>
                        </tr>
                        <tr>
                            <th>Kamera</th>
                            <td>12 MP Wide (video 4K, ProRes) + LiDAR Scanner</td>
                        </tr>
                        <tr>
                            <th>Audio</th>
                            <td>Empat buah speaker stereo, lima mikrofon kualitas studio </td>
                        </tr>
                        <tr>
                            <th>Penyimpanan</th>
                ...
                <div class="div5">
                    <table class="table-table table-sm">
                        <tr>
                            ...
                            <td>Mendukung Apple Pencil Pro (MagSafe) dan Apple Pencil (USB-C)</td>
                        </tr>
                        <tr>
                            <th>Konektivitas</th>
                        ...
                        <tr>
                            <th>Fitur AI</th>
                            <td>Apple Intelligence (beta) pada iPadOS 18</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="div7 text-center">
                    <p>iPad Pro 13 inci dengan chip M4 menawarkan performa luar biasa dalam desain tipis dan ringan. Dilengkapi layar Ultra Retina XDR OLED, penyimpanan hingga 2 TB, dan kompatibilitas dengan Apple Pencil Pro, perangkat ini cocok untuk profesional kreatif. Harga mulai Rp 17.639.000</p>
                </div>
            </div>
