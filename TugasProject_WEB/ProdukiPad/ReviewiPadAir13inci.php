...
$produk = "iPad Air 13 inci (chip m3)";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($komentar)) {
        ...
        if (mysqli_query($conn, $query)) {
            ...
            header("Location: ReviewiPadAir13inci.php");
        }
    }
}
?>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 hero-text">
                        ...
                        <p><b>Harga: </b>Mulai dari Rp 13.134.962.</p>
                    </div>
                    <div class="col-md-6 text-center">
                        <img src="iPadAir13inci(chip m3).jpg" alt="4" class="img-fluid" style="width: 400px; height:550px; border-radius:30px; box-shadow: 0 20px 36px rgb(0 0 0 / 0.1);">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="parent">
                ...
                <div class="div3">
                    <table class="table-table table-sm">
                        <tr>
                            <th>Layar</th>
                            <td>Liquid Retina 13 inci (resolusi 2560 × 1664, 264 ppi) dengan gamut warna P3, True Tone, lapisan anti-reflektif </td>
                        </tr>
                        <tr>
                            <th>Chip</th>
                            <td>Chip Apple M3 (CPU 8-core, GPU 8-core, Neural Engine 16-core)</td>
                        </tr>
                        <tr>
                            <th>Kamera</th>
                            <td>12 MP Wide (video 4K) dan 12 MP Ultra Wide (orientasi lanskap) dengan Center Stage</td>
                        </tr>
                        <tr>
                            <th>Audio</th>
                        ...
                        <tr>
                            <th>Daya & Baterai</th>
                            <td>10 - 12 Jam(penggunaan normal)</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="div7 text-center">
                    <p>iPad Air 13 inci dengan chip M3 memberikan keseimbangan antara performa dan portabilitas. Dengan layar Liquid Retina, penyimpanan hingga 1 TB, dan dukungan untuk Magic Keyboard, perangkat ini cocok untuk pelajar dan profesional. Harga mulai dari sekitar Rp 13.134.962.</p>
            </div>
