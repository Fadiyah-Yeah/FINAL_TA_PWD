...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($komentar)) {
        ...
        if (mysqli_query($conn, $query)) {
            ...
            header("Location: ReviewiPadMini.php");
        }
    }
}
?>
...
<head>
    ...
    <style>
        ...
        .section-hero,
        .section-fitur {
            background: linear-gradient(to left, #FFFFFF, #F5EFEB,rgb(171, 203, 228));
            padding: 60px 10%;
        }
                    ...
                    <div class="col-md-6 hero-text">
                        <div class="dropdown">
                            <button class="btn dropdown-toggle" type="button" id="produkDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                <h1> iPad mini (A17 Pro)</h1>
                            </button>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="ReviewiPad11inci.php">iPad 11 inci</a></li>
                                <li><a class="dropdown-item" href="ReviewiPadAir13inci.php">iPad Air 13 inci</a></li>
                                <li><a class="dropdown-item" href="ReviewiPadPro13inci.php">iPad Pro 13 inci</a></li>
                            </ul>
                        </div>
                        <p><b>Harga: </b>Mulai dari Rp 9.599.000</p>
                    </div>
                    <div class="col-md-6 text-center">
                        <img src="iPadmini(Chip A17 Pro).jpg" alt="4" class="img-fluid" style="width: 400px; height:550px; border-radius:30px; box-shadow: 0 20px 36px rgb(0 0 0 / 0.1);">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="parent">
                ...
                <div class="div3">
                    <table class="table-table table-sm">
                        <tr>
                            <th>Layar</th>
                            <td>Liquid Retina 8,3 inci (2266 × 1488 piksel, 326 ppi) dengan True Tone, lapisan oleophobic anti-sidik jari, dilaminasi penuh, kecerahan 500 nit</td>
                        </tr>
                        <tr>
                            <th>Chip</th>
                            <td>Chip Apple A17 Pro (6 core CPU, 6 core GPU, Neural Engine 16-core)</td>
                        </tr>
                        <tr>
                            <th>Kamera</th>
                            <td>12 MP Wide (video 4K, ProRes) dan 12 MP Ultra Wide (orientasi lanskap) dengan Center Stage</td>
                        </tr>
                        <tr>
                            <th>Audio</th>
                            <td>Dua speaker stereo, tiga mikrofon kualitas studio </td>
                        </tr>
                        <tr>
                            <th>Penyimpanan</th>
                        ...
                        <tr>
                            <th>Daya & Baterai</th>
                            <td>10 Jam(penggunaan normal)</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="div5">
                    <table class="table-table table-sm">
                        <tr>
                            ...
                            <td>Mendukung Apple Pencil Pro dan Apple Pencil (USB-C)</td>
                        </tr>
                        <tr>
                            <th>Konektivitas</th>
                        ...
                        <tr>
                            <th>Fitur AI</th>
                            <td>Apple Intelligence (beta di iPadOS 18)</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="div7 text-center">
                    <p>iPad mini dengan chip A17 Pro menghadirkan performa tinggi dalam ukuran kompak. Dengan penyimpanan hingga 512 GB dan dukungan untuk Apple Pencil Pro, perangkat ini cocok untuk pengguna yang menginginkan portabilitas tanpa mengorbankan performa. Harga mulai dari Rp 9.599.000</p>
                </div>
            </div>
