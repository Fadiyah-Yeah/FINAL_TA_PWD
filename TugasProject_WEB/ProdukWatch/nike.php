    ...
    <section class="section-spesifikasi text-white" id="spesifikasi">
      ...
      <div class="parent">
        ...
        <div class="div7 text-center">
          <p>Apple Watch Nike menawarkan fitur-fitur esensial Apple Watch dengan desain sporty dan aplikasi Nike Run Club, cocok untuk pengguna yang aktif dan menyukai olahraga lari</p>
        </div>
      </div>
