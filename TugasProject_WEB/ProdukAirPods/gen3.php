          ...
          <div class="col-md-6 hero-text">
            <div class="dropdown">
              <button class="btn dropdown-toggle" type="button" id="produkDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                <h1>AirPods <br>(Generasi Ke-3)</h1>
              </button>
            ...
            <p><b>Harga: </b>Mulai dari Rp 2.999.000 </p>
          </div>
          <div class="col-md-6 text-center">
            <img src="gen3.png" alt="4" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="parent">
        ...
        <div class="div3 table-responsive">
          <table class="table-table table-sm table-striped">
            ...
            <tbody>
              <tr>
                <td>Driver Apple eksdkurdi tinggi kustom</td>
                <td>Sensor deteksi kulit</td>
                <td>Mikrofon ganda pembentuk sinyal</td>
                <td>Chip headphone H1</td>
                <td>Tekan satu kali untuk memutar atau menjeda media</td>
                <td>AirPods(Masing-Masing) : Tinggi 30,79 mm; Lebar 18,26 mm; Tebal 19,21 mm; Berat 4,28 gram</td>
                <td>Waktu dengar hingga 6 jam, waktu biacara hingga 4 jam</td>
              </tr>
              <tr>
                ...
                <td></td>
                <td>Tekan satu kali untuk menjawab panggilan</td>
                <td>Casing : Tinggi 46,40 mm; Lebar 54,40 mm; tebal 21,38 mm; Berat </td>
                <td>Dengan casing, waktu dengar hingga 30 jam, waktu bicara hingga 20 jam</td>
              </tr>
              <tr>
                <td>Audia Spasial personal</td>
                <td>Akselerometer pendeteksi bicara</td>
                <td></td>
                <td></td>
        ...
        <div class="div5 table-responsive">
          <table class="table-table table-sm table-striped">
            ...
            <tr>
              ...
              <td>Fitur aksesibilitas membantu penyandang disabilitas memasimalkan AirPods Max(Audio dengar langsung, level headphone, akomodasi headphone)</td>
            </tr>
            <tr>
              <th>Isi Kotak</th>
              <td>AirPods (Generasi ke-3), Casing pengisian daya MagSafe, Kabel Lightning ke USB-C, Dokumentasi</td>
            </tr>
          </table>
        </div>
        ...
        <div class="div7 text-center">
          <p>•	AirPods (Generasi ke-3) dengan Casing Pengisian Daya MagSafe menawarkan peningkatan signifikan dalam kualitas audio dengan fitur seperti Audio Spasial Personal dan EQ Adaptif. Desain yang nyaman dan tahan air serta keringat menjadikannya pilihan ideal untuk penggunaan sehari-hari. Dengan daya tahan baterai yang lebih lama dan kontrol yang intuitif, AirPods ini dirancang untuk memberikan pengalaman mendengarkan yang superior.</p>
        </div>
      </div>
